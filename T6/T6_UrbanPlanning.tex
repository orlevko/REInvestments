...
\NormalTok{=}\KeywordTok{IRR}\NormalTok{(-}\DecValTok{120000}\NormalTok{,}\DecValTok{2000}\NormalTok{,}\DecValTok{4000}\NormalTok{,}\DecValTok{1000}\NormalTok{,}\DecValTok{5000}\NormalTok{,}\DecValTok{180000}\NormalTok{) }
\NormalTok{=}\StringTok{ }\FloatTok{10.2}\NormalTok{%}
...
\KeywordTok{BTIRRs} \NormalTok{(A) :}\StringTok{ }\DecValTok{77}\NormalTok{,}\FloatTok{272.8}\NormalTok{/(}\DecValTok{32}\NormalTok{,}\FloatTok{727.1}\DecValTok{+77}\NormalTok{,}\FloatTok{272.8}\NormalTok{) =}\StringTok{ }\FloatTok{70.25}\NormalTok{%}
...
\KeywordTok{BTIRRs} \NormalTok{(B) :}\StringTok{ }\DecValTok{115}\NormalTok{,}\FloatTok{909.3}\NormalTok{/(}\DecValTok{9}\NormalTok{,}\FloatTok{469.6}\DecValTok{+115}\NormalTok{,}\FloatTok{909.3}\NormalTok{) =}\StringTok{ }\FloatTok{92.45}\NormalTok{%}
\end{Highlighting}
\end{Shaded}
