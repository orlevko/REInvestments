...
It is 2007, interest rates are high and housing prices have been increasing for almost 15 years. You believe it is a good time to invest, and that interest rates will remain high in the future (perhaps even increase!). 

1. Which of the fixed-rate mortgage loan types (*constant payment, interest only, constant amortization*) would you prefer to accept, given your expectations? (and why?)

## Ex. 3. Answers

1. 
- We assume interest rates to remain stable, or increase. 
- "Constant payment" and "constant amortization" loans lead to full amortization at maturity. "Interest only" loan leads to zero amortization, and the outstanding amount has to be paid in full. 
- Assuming that interest rates will increase implies that mortgage payments of *all* loans will reflect gain (the difference between the loan rate and market rate), but "interest only" loan will reflect the highest gain.
